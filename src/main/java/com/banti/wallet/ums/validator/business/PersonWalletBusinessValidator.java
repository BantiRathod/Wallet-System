...
public class PersonWalletBusinessValidator {
	...
	/*
	 * public void updatePersonWalletValidatoion(UpdatePersonWalletRequest
	 * personWallet, String mobileNo) throws Exception {
	 * 
	 * PersonWallet existpersonWallet =
	 * personWalletRepository.findById(mobileNo).get(); if(existpersonWallet==null)
